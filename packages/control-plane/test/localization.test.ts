...
test("Reconciliation compatibility, strategy, field, shadow, stale, busy, acknowledgement, and restart copy is exact in both locales", () => {
  ...
  expect([
    ...
    english("reconciliation.compatibility.stale-help"),
  ...
  expect([
    ...
    chinese("reconciliation.compatibility.stale-help"),
...
test("Subscription Bridge risk and Compatibility Deviation copy is exact in both locales and public docs", () => {
  ...
  expect([
    ...
    "Tested models · gpt-5.6 and gpt-5.6-luna · text and tools",
  ...
  expect([
    ...
    "已测试模型 · gpt-5.6 和 gpt-5.6-luna · 文本与工具",
